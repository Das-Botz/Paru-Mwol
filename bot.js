...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp...')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold('✅ Paru Mwol working!')
        );
...
*/
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~_________~ Paru-Mwol ~______~*' +
                                    '\n\n*🧞‍♂️ ' + error + '*\n\n*Support group*\https://chat.whatsapp.com/Lchct1y7JYcFNDvHkkvxdC' 
                                    , MessageType.text);
                            }
                        }
                    }
